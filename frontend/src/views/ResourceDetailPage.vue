    ...
    <div class="content-width">
      ...
      <section v-else-if="resource" class="detail-layout motion-enter motion-delay-1">
        ...
        <aside class="detail-sidebar">
          ...
          <section class="detail-note glass-surface"><span>✦</span><p>学习完成后可回到能力诊断，录入客观题、实操或专家标注结果，校准本次判断。</p><button type="button" @click="$router.push(`/diagnosis/${resource.assessment_id}`)">查看诊断报告 <b>→</b></button></section>
        </aside>
      </section>
    </div>
  </main>
